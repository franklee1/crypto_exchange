...
#puts $LOAD_PATH
 ...
 def go(market,volume,side,price)
   client_public = PeatioAPI::Client.new endpoint: 'http://159.89.205.82:3000/'
   client = PeatioAPI::Client.new access_key: 'VcVKRAiPz2JIDYOUt7eIz8oX5l7eXAweaXvxeZCy', secret_key: 'Lcdql0WYp4pDucRhxZ5xUxP6SvnnXywqfFaUlJ2C', endpoint: 'http://159.89.205.82:3000/', timeout: 60
